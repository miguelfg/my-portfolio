...
-   <a href="nikola-v7814-is-out.txt" id="sourcelink" class="nav-link">Page
    Source</a>

# <a href="#" class="u-url">Nikola v7.8.14 is out!</a>

<span class="byline-name fn p-name" itemprop="author">
<a href="../authors/chris-warrick.html" class="u-url">Chris Warrick</a>
</span>

<a href="#" rel="bookmark">2018-03-31 09:41</a>

<a href="nikola-v7814-is-out.html#disqus_thread"
data-disqus-identifier="cache/posts/nikola-v7814-is-out.html">Comments</a>

<a href="nikola-v7814-is-out.txt" class="sourcelink">Source</a>

On behalf of the Nikola team, I am pleased to announce the immediate
availability of Nikola v7.8.14. This is a maintenance release for the v7
series.

Future releases in the v7 series are going to be small maintenance
releases that include bugfixes only, as work on v8.0.0 is underway. If
you wish to test new features, you can install from the master branch on
GitHub.
...
Install using `pip install Nikola` or download tarballs on
<a href="https://github.com/getnikola/nikola/releases/tag/v7.8.14"
class="reference external">GitHub</a> and
<a href="https://pypi.python.org/pypi/Nikola/7.8.14"
class="reference external">PyPI</a>.
...
-   <a href="nikola-v7813-is-out-maintenance-release.html" rel="prev"
    title="Nikola v7.8.13 is out! (maintenance release)">Previous post</a>
-   <a href="upgrading-to-nikola-v8.html" rel="next"
    title="Upgrading to Nikola v8">Next post</a>
