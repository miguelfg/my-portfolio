...
-   <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"
    ...
    <a href="#" class="dropdown-item active">Changelog <span
...
-   <a href="changes.txt" id="sourcelink" class="nav-link">Page Source</a>

# <a href="#" class="u-url">Changes</a>

## New in v8.3.2<a href="#new-in-v8-3-2" class="headerlink"
...
## New in v8.3.1<a href="#new-in-v8-3-1" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-1" class="headerlink"
title="Permalink to this heading">¶</a>

-   Support passing <span class="pre">`--poll`</span> to `nikola auto`
    to better deal with symlink farms.

### Bugfixes<a href="#bugfixes-1" class="headerlink"
title="Permalink to this heading">¶</a>
...
### Other<a href="#other-1" class="headerlink"
title="Permalink to this heading">¶</a>
...
## New in v8.3.0<a href="#new-in-v8-3-0" class="headerlink"
title="Permalink to this heading">¶</a>
...
## New in v8.2.4<a href="#new-in-v8-2-4" class="headerlink"
title="Permalink to this heading">¶</a>
...
## New in v8.2.3<a href="#new-in-v8-2-3" class="headerlink"
title="Permalink to this heading">¶</a>
...
## New in v8.2.2<a href="#new-in-v8-2-2" class="headerlink"
title="Permalink to this heading">¶</a>

-   Compatibility with Pygments 2.12.0 (Issue #3617, #3618)

## New in v8.2.1<a href="#new-in-v8-2-1" class="headerlink"
title="Permalink to this heading">¶</a>
...
## New in v8.2.0<a href="#new-in-v8-2-0" class="headerlink"
title="Permalink to this heading">¶</a>
...
## New in v8.1.3<a href="#new-in-v8-1-3" class="headerlink"
title="Permalink to this heading">¶</a>
...
## New in v8.1.2<a href="#new-in-v8-1-2" class="headerlink"
title="Permalink to this heading">¶</a>
...
## New in v8.1.1<a href="#new-in-v8-1-1" class="headerlink"
title="Permalink to this heading">¶</a>

### Bugfixes<a href="#bugfixes-9" class="headerlink"
title="Permalink to this heading">¶</a>
...
## New in v8.1.0<a href="#new-in-v8-1-0" class="headerlink"
title="Permalink to this heading">¶</a>
...
### Bugfixes<a href="#bugfixes-10" class="headerlink"
title="Permalink to this heading">¶</a>
...
### Other compatibility information<a href="#other-compatibility-information" class="headerlink"
title="Permalink to this heading">¶</a>

1.  Nikola no longer requires logbook. You may need to upgrade plugins.

2.  If you receive an error stating that *sitemap is not a package*, you
    need to remove a leftover `nikola/plugins/task/sitemap` directory
    (the full path is in the error message).

## New in v8.0.3<a href="#new-in-v8-0-3" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-9" class="headerlink"
title="Permalink to this heading">¶</a>
...
### Bugfixes<a href="#bugfixes-12" class="headerlink"
title="Permalink to this heading">¶</a>
...
## New in v8.0.2<a href="#new-in-v8-0-2" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-10" class="headerlink"
title="Permalink to this heading">¶</a>
...
### Bugfixes<a href="#bugfixes-13" class="headerlink"
title="Permalink to this heading">¶</a>
...
## New in v8.0.1<a href="#new-in-v8-0-1" class="headerlink"
title="Permalink to this heading">¶</a>

-   Not compatible with Markdown 3.x yet, this release pins the
    requirement down to 2.x (until we get 3.x support done)

### Features<a href="#features-11" class="headerlink"
title="Permalink to this heading">¶</a>

-   Make URL displayed by `nikola auto` and `nikola serve` clickable
    (Issue #3166)

### Bugfixes<a href="#bugfixes-14" class="headerlink"
title="Permalink to this heading">¶</a>

-   Pandoc compiler was passing deleted argument (Issue #3171)

-   Make `nikola version `<span class="pre">`--check`</span> work again
    (Issue #3170)

-   Set logging level for reST to warning in order to limit noise

-   Fix docinfo removal for sites that use reST docinfo metadata (Issue
    #3167)

## New in v8.0.0<a href="#new-in-v8-0-0" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   You need `<a `<span class="pre">`class="reference">`</span> (instead
    of <span class="pre">`image-reference`</span>) to activate the
    lightbox now

-   Date formatting now uses the Babel library, you might need to change
    `BABEL_FORMAT` (Issues #2606, 3121)

-   The first heading in a reST document is not removed anymore by
    default unless `USE_REST_DOCINFO_METADATA` is enabled (Issues #2382,
    #3124)

### Features<a href="#features-12" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Don’t generate gallery index if the destination directory is site
    root and it would conflict with blog index (Issue #3133)

-   All built-in themes now support `updated` timestamp fields in posts.
    The update time, if it is specified and different from the posting
    time, will be displayed as "{postDate} (${messages("updated")}
    {updateDate})". If no update time is specified, the posting time
    will be displayed alone.

-   All built-in themes now support the `DATE_FANCINESS` option.

-   Theme bundles are now parsed using the configparser module and can
    support newlines inside entries as well as comments

-   Make bootstrap4 navbar color configurable with
    <span class="pre">`THEME_CONFIG['navbar_light']`</span> (Issue
    #2863)

-   New data_file option for chart shortcode and directive (Issue #3129)

-   Show the filename of the missing file when `nikola serve` can't find
    a file (i.e. when an 404 error occurs).

-   Better error messages for JSON download failures in `nikola plugin`
    and `nikola theme` (Issue getnikola/plugins#282)
...
### Bugfixes<a href="#bugfixes-15" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Do not remove first heading in document (reST document title) if
    `USE_REST_DOCINFO_METADATA` is disabled (Issue #3124)

-   Remove `NO_DOCUTILS_TITLE_TRANSFORM` setting, this is now default
    behavior if `USE_REST_DOCINFO_METADATA` is disabled (Issue #2382,
    #3124)

-   Enforce trailing slash for directories in `nikola auto` (Issue
    #3140)
...
-   Moved `tag_cloud_data.json` generation to a separate `tagcloud`
    plugin (Issue #1696)

-   The `webassets` library is no longer required, we now manually
    bundle files (Issue #3074)

## New in v7.8.15<a href="#new-in-v7-8-15" class="headerlink"
title="Permalink to this heading">¶</a>
...
## New in v7.8.14<a href="#new-in-v7-8-14" class="headerlink"
title="Permalink to this heading">¶</a>

-   doit v0.31.0 compatibility (Issue #2980, #3004, v8 backport)

## New in v7.8.13<a href="#new-in-v7-8-13" class="headerlink"
title="Permalink to this heading">¶</a>

-   Add new Thai translation by Narumol Hankrotha and Jean Jordaan (v8
    backport)
...
## New in v7.8.12<a href="#new-in-v7-8-12" class="headerlink"
title="Permalink to this heading">¶</a>

-   Fix loading non-default languages

## New in v7.8.11<a href="#new-in-v7-8-11" class="headerlink"
title="Permalink to this heading">¶</a>
...
## New in v7.8.10<a href="#new-in-v7-8-10" class="headerlink"
title="Permalink to this heading">¶</a>
...
## New in v7.8.9<a href="#new-in-v7-8-9" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Fix a bug in HTML meta parsing that crashed on `<meta>` tags without
    `name` (Issue #2835)

-   Fix math not showing up in some circumstances (Issue #2841)

## New in v7.8.8<a href="#new-in-v7-8-8" class="headerlink"
title="Permalink to this heading">¶</a>

This release fixes two grave bugs in TOML metadata support (sorry!). The
built-in themes have also been cleaned up and include less unused
assets. In addition, taxonomies now support translations. HTML meta tags
are also possible metadata sources. The default metadata format to
generate can now be changed.

### Features<a href="#features-13" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Extract metadata from HTML meta and title tags like Pelican (Issue
    #1923)

-   Update assets in the `base` and
    <span class="pre">`base-jinja`</span> themes and clean up code
    (Issue #2744)

-   Show captions in the base theme gallery (Part of issue #2777)

### Bugfixes<a href="#bugfixes-16" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Add alt attribute to images in galleries in base theme (Part of
    issue #2777)
...
## New in v7.8.7<a href="#new-in-v7-8-7" class="headerlink"
title="Permalink to this heading">¶</a>

In an effort to improve interoperability with other static site
generators, make importing data easier, and help with world domination,
Nikola v7.8.7 ships with support for the following metadata formats:
...
In addition, Markdown is now enabled and required by default. More
details:
\<<a href="https://getnikola.com/handbook.html#metadata-formats"
class="reference external">https://getnikola.com/handbook.html#metadata-formats</a>\>

The release also fixes two important bugs, one that crashes when trying
to detect locale in some edge cases, and another which made some themes
quietly leak template files. If you’re using a Jinja2-based theme that
does not have its own `parent` file, please force a rebuild
(`nikola build `<span class="pre">`-a`</span>).

### Features<a href="#features-14" class="headerlink"
title="Permalink to this heading">¶</a>

-   Enable markdown by default (part of Issue #2809)

-   Allowing to register filters from plugins, and allowing to specify
    default filters as strings of the form
    <span class="pre">`filters.<name>`</span> (part of Issue #2475)

-   Support ignoring assets via `ignore_assets` theme meta field (Issue
    #2812)
...
-   Support for reStructured text docinfo metadata with
    `USE_REST_DOCINFO_METADATA` option, defaulting to False (Issue
    #1923)
...
### Bugfixes<a href="#bugfixes-17" class="headerlink"
title="Permalink to this heading">¶</a>
...
## New in v7.8.6<a href="#new-in-v7-8-6" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-15" class="headerlink"
title="Permalink to this heading">¶</a>
...
### Bugfixes<a href="#bugfixes-18" class="headerlink"
title="Permalink to this heading">¶</a>

-   Use `locale.getdefaultlocale()` for better locale guessing (credit:
    @madduck)
...
## New in v7.8.5<a href="#new-in-v7-8-5" class="headerlink"
title="Permalink to this heading">¶</a>

### Math support changes<a href="#math-support-changes" class="headerlink"
title="Permalink to this heading">¶</a>
...
### Features<a href="#features-16" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Added `jpegoptim_progressive` filter to convert jpeg images to
    progressive jpegs.

### Bugfixes<a href="#bugfixes-19" class="headerlink"
title="Permalink to this heading">¶</a>

-   Open `127.0.0.1` when using
    `nikola serve `<span class="pre">`-b`</span> and default `0.0.0.0`
    hostname to avoid resolution issues — the site is still available on
    all interfaces (Issue #2755)
...
-   No longer creates empty subarchive pages, and no longer create
    broken archive navigation links on day level (Issue #2734)
...
-   Improving support for PostScanner plugins by asking them which
    compilers are unused (Issue #2496)

## New in v7.8.4<a href="#new-in-v7-8-4" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-17" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Make `nikola plugin `<span class="pre">`--list-installed`</span>
    more readable (Issue #2692)

-   Accept `now` in post-list date conditions

-   Add `RSS_COPYRIGHT`, `RSS_COPYRIGHT_PLAIN`, and
    `RSS_COPYRIGHT_FORMATS` options in conf.py which can be disabled by
    specifying `copyright_=False` to `generic_rss_renderer`, or
...
-   Add a `require_all_tags` parameter to the
    <span class="pre">`post-list`</span> directive to show only posts
    that have all specified tags. (Issue #2665)
...
### Bugfixes<a href="#bugfixes-20" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Prevent writing cache files outside of the cache folder (Issue
    #2684)
...
## New in v7.8.3<a href="#new-in-v7-8-3" class="headerlink"
title="Permalink to this heading">¶</a>

Emergency bugfix release (`nikola new_page` did not work in v7.8.2).

### Features<a href="#features-18" class="headerlink"
title="Permalink to this heading">¶</a>
...
### Bugfixes<a href="#bugfixes-21" class="headerlink"
title="Permalink to this heading">¶</a>

-   Fix a bug that prevents `nikola new_page` from working (Issue #2631)

## New in v7.8.2<a href="#new-in-v7-8-2" class="headerlink"
title="Permalink to this heading">¶</a>
...
values, adding `shortcode_deps` and shortcode support. See issues #2623
and #2624.

### Features<a href="#features-19" class="headerlink"
title="Permalink to this heading">¶</a>

-   Add meta generator tag to default templates to promote Nikola (Issue
    #2619)

-   Add `nikola new_post `<span class="pre">`-d`</span> and
    `NEW_POST_DATE_PATH` to allow automatic creation of year/month/day
    (date-based) directory structures (Issue #2513)
...
-   Allow posts to set custom `URL_TYPE` by using the `url_type` meta
    tag (useful for HTML fragments inserted using JavaScript)

-   Plugins can depend on other plugins being installed (Issue #2533)

-   The destination folder in `POSTS` and `PAGES` can now be translated
    (Issue #2116)
...
-   There is a new plugin category `Taxonomy` which allows to easily
    ...
    archives, indexes, page index, sections, tags, and categories) have
    been converted to the new system. (Issue #2107)

-   Added `CATEGORIES_INDEX_PATH`, similar to `TAGS_INDEX_PATH`. (Issue
    #2567)

-   Made `INDEX_PATH`, `RSS_PATH` and `AUTHOR_PATH` translatable. (Issue
    #1914)
...
-   Added settings `DISABLE_INDEXES_PLUGIN_INDEX_AND_ATOM_FEED` and
    `DISABLE_INDEXES_PLUGIN_RSS_FEED` to disable specific parts of the
    `classify_indexes` taxonomy plugin. (Issue #2591)

### Bugfixes<a href="#bugfixes-22" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   WordPress importer now correctly handles &amp; etc. in tags. (Issue
    #2557)

-   If `CODE_COLOR_SCHEME` is empty, don’t generate `code.css` (Issue
    #2597)

-   Don’t warn about `nikolademo` DISQUS account when comments are
    disabled (Issue #2588)

-   Make `data` from global context available to templated shortcodes as
    `global_data` (Issue #2488)
...
## New in v7.8.1<a href="#new-in-v7-8-1" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-20" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Add `nikola theme `<span class="pre">`--list-installed`</span>
    (Issue #2504)
...
### Bugfixes<a href="#bugfixes-23" class="headerlink"
title="Permalink to this heading">¶</a>

-   Rename `stories` to `pages` in most of the codebase (Issue #1891)

-   Report missing/unknown dates in posts with filenames (Issues #2505,
    #2506)

-   Report filename of post that raised exception when scanning (Issue
    #2505)
...
## New in v7.8.0<a href="#new-in-v7-8-0" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-21" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   New `data` metadata that loads data from external files (Issue
    #2450)
...
-   Added new options --html2text and --transform-to-markdown to
    WordPress importer (Issue #2261)

-   Listing: guess the lexer if cannot be determined from the file name.

-   Read files from data/ and insert data in global context (Issue
    #2477)

### Bugfixes<a href="#bugfixes-24" class="headerlink"
title="Permalink to this heading">¶</a>

-   Added link to sources in the output of listing directive (Issue
    #2472)

-   Fix Windows crash with calendar locales (Issue #2332)

-   Remove the (useless) `<base>` tag by default; change conf.py to opt
    in (Issue #2471)

-   Show tag descriptions when TAG_PAGES_ARE_INDEXES is True (Issue
    #2444)
...
## New in v7.7.12<a href="#new-in-v7-7-12" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-22" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Add `EXTRA_THEMES_DIRS` search path, similar to
    `EXTRA_PLUGINS_DIRS`, to locate themes at other places (Issue #2427)

### Bugfixes<a href="#bugfixes-25" class="headerlink"
title="Permalink to this heading">¶</a>

-   Added code documentation to ReadTheDocs (Issue #2124)
    (<a href="https://nikola.readthedocs.io/en/latest/"
    class="reference external">https://nikola.readthedocs.io/en/latest/</a>)
...
## New in v7.7.11<a href="#new-in-v7-7-11" class="headerlink"
title="Permalink to this heading">¶</a>

### Bugfixes<a href="#bugfixes-26" class="headerlink"
title="Permalink to this heading">¶</a>

-   Brown bag bug in image resizing (ralsina says my fault!)

## New in v7.7.10<a href="#new-in-v7-7-10" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-23" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Added <span class="pre">`post-(type)`</span> class to `story.tmpl`
    (uses the `type` meta field, defaults to
    <span class="pre">`post-text`</span> — same behavior as posts)

-   New `compiled` signal after post is compiled (Issue #2369)

### Bugfixes<a href="#bugfixes-27" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Add horizontal scrollbar to listings (via
    getnikola/nikola-themes#86)
...
## New in v7.7.9<a href="#new-in-v7-7-9" class="headerlink"
title="Permalink to this heading">¶</a>

(1000+ stars on GitHub — thanks!)

### Features<a href="#features-24" class="headerlink"
title="Permalink to this heading">¶</a>

-   New `sc` or `html` reST role, which passes content unaltered (Issue
    #1854)
...
### Bugfixes<a href="#bugfixes-28" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Create Persistor directories only if site is configured (Issue
    #2334)

-   Remove newlines in imported WordPress titles (Issue #2330)

## New in v7.7.8<a href="#new-in-v7-7-8" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-25" class="headerlink"
title="Permalink to this heading">¶</a>

-   Template-based shortcodes now receive positional arguments too
    (Issue #2319)

### Bugfixes<a href="#bugfixes-29" class="headerlink"
title="Permalink to this heading">¶</a>

-   Fix folder handling and redirects in `nikola auto` (Issue #2331)

-   Use state files in `nikola github_deploy` and `nikola status` (Issue
    #2317)

-   Add `align` options for `youtube`, `vimeo`, `soundcloud` reST
    directives (Issue #2304)
...
## New in v7.7.7<a href="#new-in-v7-7-7" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-26" class="headerlink"
title="Permalink to this heading">¶</a>

-   New <span class="pre">`--one-file`</span> option to wordpress
    importer (Issue #2262)
...
### Bugfixes<a href="#bugfixes-30" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Don’t display “Good link” messages in
    `nikola check `<span class="pre">`-l`</span> by default, can be
    re-enabled with <span class="pre">`-v`</span> option (Issue #2268)

-   Fix a format string in `nikola check` (Issue #2267)

-   Don't crash wordpress importer when posts are "empty" (Issue #2263)

-   Don't put untranslated and nonexistant posts in sitemap (Issue
    #2289)

## New in v7.7.6<a href="#new-in-v7-7-6" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-27" class="headerlink"
title="Permalink to this heading">¶</a>

-   Add `FRONT_INDEX_HEADER` setting to allow adding greeting notices to
    the main index page (Issue #2249)

### Bugfixes<a href="#bugfixes-31" class="headerlink"
title="Permalink to this heading">¶</a>

-   Make Jupyter posts build (Issues #2248, #2252)

## New in v7.7.5<a href="#new-in-v7-7-5" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-28" class="headerlink"
title="Permalink to this heading">¶</a>

-   Add `nikola theme `<span class="pre">`--new`</span> command for
    creating new themes (Issue #2231)

-   Add `nikola theme `<span class="pre">`--copy-template`</span>
    command for copying templates to customize them (Issue #2231)

-   Add `nikola theme `<span class="pre">`--uninstall`</span> command
    for deleting themes (Issue #2231)

-   Replace `nikola install_theme` with more capable `nikola theme`
    command (Issue #2231)

-   Allow for customizing `github_deploy` commit messages with
    <span class="pre">`-m`</span> (Issue #2198)

-   Commit to source branch automatically in `github_deploy` if
    `GITHUB_COMMIT_SOURCE` is set to True (Issue #2186)

-   Hugo-like shortcodes (Issue #1707)

-   New Galician translation

-   New PRESERVE_EXIF_DATA option to copy EXIF when resizing images
    (Issue #2204)

-   New facilities for data persistence and data caching (Issues #2209
    and #2009)

-   (internal) allow `scripts/jinjify.py` usage with scripts (Issue
    #2240)

### Bugfixes<a href="#bugfixes-32" class="headerlink"
title="Permalink to this heading">¶</a>
...
## New in v7.7.4<a href="#new-in-v7-7-4" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-29" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Automatically open gallery images colorbox based on URL fragment
    (Issue #2146)

### Bugfixes<a href="#bugfixes-33" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Check HTTP response status of minifying tools and skip them if
    they’re unavailable

-   Change rewrite rule for fragment-only links (Issue #2132)

-   Mention disabled plugins in
    `nikola plugin `<span class="pre">`--list-installed`</span> (Issue
    #2139)

-   Don't examine all gallery image dates every build (Issue #2160)

## New in v7.7.3<a href="#new-in-v7-7-3" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-30" class="headerlink"
title="Permalink to this heading">¶</a>

-   Recommend <span class="pre">`ghp-import2`</span> (better packaging)
    (Issue #2152)

-   New `TAGS_INDEX_PATH` option for overwriting the path of the tag
    index list page.
...
-   `serve` and `auto` publishes DNS Service Discovery records to the
    local network announcing they’re running web servers.

### Bugfixes<a href="#bugfixes-34" class="headerlink"
title="Permalink to this heading">¶</a>
...
## New in v7.7.2<a href="#new-in-v7-7-2" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-31" class="headerlink"
title="Permalink to this heading">¶</a>
...
### Bugfixes<a href="#bugfixes-35" class="headerlink"
title="Permalink to this heading">¶</a>

-   Support Pillow v3.0.0 (Issue #2130)

-   Support setting template in metadata in translated posts (Issue
    #2114)
...
### Deprecations<a href="#deprecations" class="headerlink"
title="Permalink to this heading">¶</a>
...
## New in v7.7.1<a href="#new-in-v7-7-1" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-32" class="headerlink"
title="Permalink to this heading">¶</a>
...
### Bugfixes<a href="#bugfixes-36" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Locale is now threadsafe, avoid races in threaded builds (Issue
    #2071)
...
## New in v7.7.0<a href="#new-in-v7-7-0" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-33" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   New `POSTS` output subfolders now generate sections by deault (Issue
    #1980)

-   New `POSTS_SECTIONS` and `POSTS_SECTION_*` options for configuring
    the section pages (Issue #1980)
...
-   Each new section page has a auto-assigned color based on shifting
    the hue of `THEME_COLOR` based on a hash of the section name, can be
    overwritten with `POSTS_SECTION_COLORS` option (Issue #1980)

-   New `TAG_PAGES_TITLES` and `CATEGORY_PAGES_TITLES` options (Issue
    #1962)

-   Add Bosnian and Serbian (Latin) languages, by Saša Savić \[bs,
    sr_latin\]

-   Add Portuguese (Portugal) language, by jamatos \[pt\]

### Bugfixes<a href="#bugfixes-37" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Check <span class="pre">`img|source[@srcset]`</span> as part of
    `check `<span class="pre">`-l`</span> (Issue #1989)

-   Clean up translations for third party components

-   <span class="pre">`pagekind["main_index"]`</span> set on the main
    indexes to differentiate them from all the other indexes.

-   Add dependency on metadata file for 2-file posts (Issue #1968)

-   Set UTF-8 charset in Content-Type or `text/*` and `*+xml` (Issue
    #1966)

## New in v7.6.4<a href="#new-in-v7-6-4" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-34" class="headerlink"
title="Permalink to this heading">¶</a>
...
### Bugfixes<a href="#bugfixes-38" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Make Nikola startup faster by not loading useless plugins (Issue
    #1825)

-   Ignore sliced multibyte characters when reading metadata for
    sitemaps

-   Fix NameError caused by failed import in auto plugin.

## New in v7.6.3<a href="#new-in-v7-6-3" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-35" class="headerlink"
title="Permalink to this heading">¶</a>

-   New translations: Serbian and Bosnian, by saleone

-   Added mechanism for rest extensions to depend on configuration
    options (Issue #1919)

-   Render Jupyter notebooks (ipynb) in listings (Issue #1900)

### Bugfixes<a href="#bugfixes-39" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Set a base element to aid relative URL resolution, stripped
    on-the-fly when using the auto or serve command to view site
    locally. (Issue #1922)
...
-   "nikola auto" serving implicit index.html with wrong mime type
    (Issue #1921)

-   Handle non-integer shutter speeds and other variables in WordPress
    importer (Issue #1917)

## New in v7.6.2<a href="#new-in-v7-6-2" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-36" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Remove empty directories with nikola check --clean-files (Issue
    #1873)

### Bugfixes<a href="#bugfixes-40" class="headerlink"
title="Permalink to this heading">¶</a>

-   Don't auto-rebuild on changes to ".foo" or "foo~" or changes in
    folders.
...
-   Retry all client errors (4xx) to HEAD as GET reques when checking
    remote links

-   Graceful fallback in
    `nikola serve `<span class="pre">`--detach`</span> on Windows (Issue
    #1913)
...
-   Don’t get metadata from file if compiler-specific metadata exist
    (Issue #1904)
...
## New in v7.6.1<a href="#new-in-v7-6-1" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-37" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Several improvements to WordPress importer (PR #1867):
    ...
    -   Allowing to exclude private posts, and allowing to include empty
        posts

    -   Allowing to use HTTP authentication for downloads with
        --download-auth (PR #1848)

    -   Allowing to export comments with --export-comments

    -   Allowing to use WordPress page compiler to directly convert
        posts to HTML on import with --transform-to-html

    -   Allowing to use WordPress page compiler on imported site instead
        of converting posts to markdown with --use-wordpress-compiler

    -   Allowing to automatically install the WordPress page compiler
        when needed with --install-wordpress-compiler

    -   Exporting information on attachments per post as JSON (#1867 and
        #1888)

    -   Exporting post status and excerpt

-   New ‘pagekind’ variable available to identify different kind of
    pages from theme templates

-   Add <span class="pre">`--no-server`</span> option to `nikola auto`
    (Issue #1883)
...
-   Add <span class="pre">`-d`</span>,
    <span class="pre">`--detach`</span> option to `nikola serve` (Issue
    #1871)

-   Use provided teaser format (`*_READ_MORE_LINK`) with custom teaser
    text (Issue #1879)
...
### Bugfixes<a href="#bugfixes-41" class="headerlink"
title="Permalink to this heading">¶</a>

-   Use `http` as fallback in plugin/theme installers if a SSL error
    occurs (Issue getnikola/nikola-themes#49)

-   Add missing `xmlns:xhtml` namespace to sitemaps (Issue #1890)

-   Fixed superfluous rebuild problems with Python 3. Note that this
    will cause rebuilds for most sites. (Issue #1887)
...
-   Fix spurious warnings about posts published in the future (Issue
    #1850)

## New in v7.6.0<a href="#new-in-v7-6-0" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-38" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Add <span class="pre">`-F`</span>,
    <span class="pre">`--available-compilers`</span> option to
    `nikola new_post` and `nikola new_page` (Issue #1837)

-   Add print CSS to all default themes (Issue #1817)

-   Support other kernels for ipynb/Jupyter using
    `nikola new_post `<span class="pre">`-f`</span>` ipynb@kernel`
    (Issues #1774, #1834)
...
### Bugfixes<a href="#bugfixes-42" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Quietly ignore non-existent files in
    `nikola check `<span class="pre">`-l`</span> (Issue #1831)
...
## New in v7.5.1<a href="#new-in-v7-5-1" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-39" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   New `nikola version `<span class="pre">`--check`</span> option
    (Issue #1767)

### Bugfixes<a href="#bugfixes-43" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Handle missing dependencies better in auto plugin (Issues #1803,
    #1809)
...
## New in v7.5.0<a href="#new-in-v7-5-0" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-40" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Automatically mark ipynb posts/pages as requiring mathjax (Issue
    #1782)
...
-   Allowing category hierarchies via new option
    CATEGORY_ALLOW_HIERARCHIES (Issue #1520)

### Bugfixes<a href="#bugfixes-44" class="headerlink"
title="Permalink to this heading">¶</a>

-   Dropped empty languages (fil, tl, zh_TW)

-   Extract `nikola check` target list from actual task list instead of
    parsing (Issue #1758)
...
-   Use a global directory for gallery images, ignoring translations
    (Issue #1726)

-   The post-list directive only triggers rebuilds if timeline changes
    (Issue #1688)

-   Don’t check the same remote URL more than once (Issue #1732)

-   All remotely checked links resulted in incorrect warnings (nikola
    check -lr)
...
## New in v7.4.1<a href="#new-in-v7-4-1" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-41" class="headerlink"
title="Permalink to this heading">¶</a>

-   Better handling of missing/unconfigured compilers (Issue #1704)

-   New -r option for the link checker to check remote links (Issue
    #1684)

-   Use static navbars in bootstrap3 and bootstrap themes

### Bugfixes<a href="#bugfixes-45" class="headerlink"
title="Permalink to this heading">¶</a>
...
## New in v7.4.0<a href="#new-in-v7-4-0" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-42" class="headerlink"
title="Permalink to this heading">¶</a>

-   Substitutions for RSS_LINKS_APPEND_QUERY for identifying the source
    feed (feedRelUri) and the kind of feed (feedFormat).

-   New option GENERATE_ATOM, off by default

-   Current and archive Atom feeds for indexes; category, tag, and
    archive indexes (RFC-4287 and RFC-5005)
...
-   Set default new site URL to <a href="https://example.com/"
    class="reference external">https://example.com/</a>

-   Plugins can manipulate task dependencies (Issue #1679)

-   LINK_CHECK_WHITELIST now works with output relative and full fs
    paths

-   Four new filters: html_tidy_nowrap, html_tidy_wrap,
    html_tidy_wrap_attr, and html_tidy_mini for prettification and
    minification. Requires tidy5.
...
-   Add `HIDDEN_TAGS` and `HIDDEN_CATEGORIES` settings to hide some tags
    and categories (eg. `mathjax`) from view (Issue #1640)

-   Instruct browsers to prefetch newest post when visiting the front
    page

-   Add a `sort` parameter to the post-list directive to sort posts in
    the list using natsort. (Issue #1635)

### Bugfixes<a href="#bugfixes-46" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Posts/Pages that use post-list will never be up to date (Issue
    #1671)
...
-   Encode IDNs to Punycode in `nikola init` and in links; show an error
    if the site URL is not Punycode (Issue #1644)

-   Make `images` the default output directory for IMAGE_FOLDERS (Issue
    #1663)

-   Don't default to any swatch in bootswatch_theme (Issue #1656)

-   Fix `nikola check `<span class="pre">`-l`</span> for absolute and
    full-path URL styles (Issue #1650)
...
## New in v7.3.1.1<a href="#new-in-v7-3-1-1" class="headerlink"
title="Permalink to this heading">¶</a>

-   Emergency release to pin doit version to 0.27.0

-   No code changes since v7.3.1 (not even
    `nikola `<span class="pre">`--version`</span>)

## New in v7.3.1<a href="#new-in-v7-3-1" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-43" class="headerlink"
title="Permalink to this heading">¶</a>
...
### Bugfixes<a href="#bugfixes-47" class="headerlink"
title="Permalink to this heading">¶</a>
...
## New in v7.3.0<a href="#new-in-v7-3-0" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-44" class="headerlink"
title="Permalink to this heading">¶</a>

-   Added possibility for plugins to define how to read metadata from
    files

-   Added <span class="pre">`-a`</span>,
    <span class="pre">`--author`</span> option to set post author field

-   Added option INDEXES_PRETTY_PAGE_URL to make URLs for indexes pages
    more pretty. (Issue #1548)

-   Added <span class="pre">`-i`</span>,
    <span class="pre">`--import`</span> argument to `new_post` for
    importing existing post contents (Issue #1385)
...
-   Added new option ARCHIVES_ARE_INDEXES which allows archive pages
    which list posts to be rendered with the post contents. (Issue
    #1537)

-   Added new option INDEXES_STATIC which allows to define the page
    ordering for indexes (Issue #1537). Also, if tag pages are created
    as indexes, they will behave more close to the default indexes.

-   Use `table` line-numbering style with reST code, making copy-pasting
    code possible (Issue #1285)
...
-   New advanced option RSS_LINKS_APPEND_QUERY for tracking traffic from
    RSS subscribers
...
### Bugfixes<a href="#bugfixes-48" class="headerlink"
title="Permalink to this heading">¶</a>

-   Handle over-and-under-lined titles in rst for guessing title (Issue
    #1539)

-   Don't apply colorbox to figures if they are of islink class. (Issue
    #1536)
...
-   Fixed `rss.xsl` path for blogs not deployed to server root (Issue
    #1563)

-   Respect SHOW_UNTRANSLATED_POSTS = False in archives and for
    untranslated source files (Issue #1360)
...
## New in v7.2.0<a href="#new-in-v7-2-0" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-45" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Allow presets usage with `nikola deploy` — `DEPLOY_COMMANDS` is now
    a dict of {preset: commands} (Issue #1452)

-   New `GLOBAL_CONTEXT_FILLER` setting, functions listed there will be
    called with the local context and the template name before template
    rendering. (Issue #1451)

-   New `USE_CDN_WARNING` setting to block warnings about potential
    `USE_CDN` misuse (defaults to True)

-   `nikola check `<span class="pre">`-l`</span> will warn about
    mixed-security (HTTP on HTTPS)
...
### Bugfixes<a href="#bugfixes-49" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Don’t check cache/ in `nikola check `<span class="pre">`-l`</span>
    (Issue #1447)
...
-   Handle better `new_post `<span class="pre">`--format=pandoc`</span>
    when pandoc is not defined (Issue #1422)
...
-   Fix broken `auto `<span class="pre">`-b`</span> option (Issue #1437)

## New in v7.1.0<a href="#new-in-v7-1-0" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-46" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Added `minify_lines` filter to strip leading whitespace and empty
    lines
...
-   Added `USE_SLUGIFY` (defaults to True). If it’s False, Nikola allows
    and generates almost any Unicode character in page URLs (Issue
    #1321)
...
-   Added support for enclosures (via optional enclosure metadata tag)
    (Issue #1322)

### Bugfixes<a href="#bugfixes-50" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   fix error message when tags that are too similar are found (Issues
    #1343, #1344)
...
-   PHP compiler now removes metadata comments the usual way (Issue
    #1374)
...
## New in v7.0.1<a href="#new-in-v7-0-1" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-47" class="headerlink"
title="Permalink to this heading">¶</a>

-   added <span class="pre">`-e`</span>,
    <span class="pre">`--edit`</span> parameter to `new_post` and
    `new_page` to open $EDITOR after creation (Issue #1294)

-   added `scanned` signal (after posts are scanned) (via Issue #1291)

-   added missing `initialized` event (after tasks are loaded) (Issue
    #1291)

### Bugfixes<a href="#bugfixes-51" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   “fixed” a weird bug which tried to find the \_\_file\_\_ of
    \_\_builtin\_\_
...
## New in v7.0.0<a href="#new-in-v7-0-0" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-48" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Add a `github_deploy` command to deploy to GitHub pages (Issue
    #1208)

-   Remove tidy filter (it was broken due to tidy being ancient) (Issue
    #1164)

-   Added `GENERATE_RSS` setting to allow disabling RSS in Nikola (Issue
    #1236)
...
-   The base theme comes with a new stylish look by default (Issue
    #1137)
...
-   Added FORCE_ISO8601 setting that currently makes new_post use ISO
    8601 dates (via Issue #1156)
...
-   `nikola import_wordpress` now has a
    <span class="pre">`--qtranslate`</span> option, to parse posts in
    the qtranslate wordpress plugin format and turn them into
    multilingual Nikola posts (Issue #1072)

-   `nikola console` allows for interpreter choice via -b, -i, -p;
    moreover, support for bpython is not deprecated anymore (Issue
    #1126)

-   `retired` tag for posts has been replaced with `private` (via Issue
    #686)
...
-   Added a `CONTENT_FOOTER_FORMATS` config option. It is used to format
    the `CONTENT_FOOTER` variable properly, for compatibility with the
    Translatable Settings feature. The variable takes a dict, the keys
...
-   Remove old messages left over for backwards compatibility: (Issues
    #829, #1105)
...
-   New option RSS_PLAIN to optionally strip HTML from RSS feeds (Issue
    #1107)

-   Support content key in compilers' create_post (Issue #1098)

-   Use setuptools’ extras feature. Use `pip install nikola[extras]` to
    install Nikola with extras
    (<span class="pre">`requirements-extras.txt`</span>, formerly
    <span class="pre">`requirements-full.txt`</span> -- note the name
    change!) (Issue #1089)

### Bugfixes<a href="#bugfixes-52" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Not having typogrify installed now produces a valid error (Issue
    #1262)
...
-   `nikola COMMAND `<span class="pre">`-h/--help`</span> now outputs
    command help and not Nikola help (showing the command help is
    standard behavior) (Issue #1245)

-   Redirect pages should have a body linking to the new location

-   The typogrify filter is now Python 3-compatible (Issue #1244)

-   Fix `nikola auto` not watching changes in FILES_FOLDERS (Issue
    #1241)

-   Vimeo and YouTube embedding in reStructuredText is now
    protocol-relative

-   Don't crash if a unknown kind of path/link is requested (Issue
    #1236)
...
-   Ensure the locale is set correctly when compiling posts (Issue
    #1219)

-   Fix site-dependent commands (they tried to run anyways) (Issue
    #1223)
...
-   Galleries are more usable in non-Bootstrap-based themes (Issue
    #1137)
...
-   Catch keyboard exit while serving so traceback does not show (Issue
    #1124)

-   Support rescanning posts in the Nikola class (Issue #1100)

-   Use TIMEZONE with `nikola new_post` and `nikola new_page`. (Issue
    #1088)

## New in v6.4.0<a href="#new-in-v6-4-0" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-49" class="headerlink"
title="Permalink to this heading">¶</a>

-   Add `nikola new_page` command (equivalent to
    `nikola new_post `<span class="pre">`-p`</span>) (Issue #1060)
...
-   Support :linenos: in code blocks for Sphinx compatibility (Issue
    #1010)

-   New link:///foo links which always point to absolute paths (/foo in
    that case) (Issue #986)

-   Bootstrap 3 has been updated to v3.1.1 (Issue #1015)

-   New --browser/-b option on the serve command to open instantly in a
    web browser (Issue #997)

-   SASS/LESS files and targets file will be processed from site root
    (Issue #941)

### Bugfixes<a href="#bugfixes-53" class="headerlink"
title="Permalink to this heading">¶</a>

-   lastdeploy time recording was broken, changed to ISO format (Issue
    #1083)

-   Avoid undefined behaviour if NAVIGATION_LINKS is missing keys for a
    translation (Issue #1082)
...
-   nikola check supports URL_TYPE="absolute" and URL_TYPE="full_path"
    (Issue #1046)

-   Fix URL_TYPE=absolute and URL_TYPE=full_path on non-root sites
    (Issue #1046)
...
-   If two tags generate the same slug, they are the same tag (Issue
    #1022)
...
-   Change code.css and rst.css to have sane output everywhere (Issues
    #913, #1009, #1050)
...
-   Fixed SASS/LESS errors when more than one theme in chain has a
    targets file (Issue #941)

-   Guard against empty list-items in base templates (Issue #936)

## New in v6.3.0<a href="#new-in-v6-3-0" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-50" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Added a DEMOTE_HEADERS option (on by default; previously implemented
    by the Markdown and reST compilers) to have consenting compilers
    produce documents with headers lower by one than the one defined
    (Issue #891)
...
-   Added SASS_COMPILER option (defaults to sass) to add support for
    alternate compilers like sassc (Issue #940)

-   Added LESS_COMPILER option (defaults to lessc) to add support for
    alternate compilers like recess (via Issue #940)
...
-   Added EXTRA_PLUGINS_DIRS option, for specifying additional plugin
    directories (Issue #953)

-   Expose original doit "auto" command as "doit_auto" (Issue #955)

-   New "type" metadata to make differences for posts (Issue #927)

-   New Post.is_post attribute to differentiate posts and pages without
    bias (Post.use_in_feeds is False if the post is
    retired/unpublished/a draft)

-   Add rel=canonical \<link\> elements (Issue #449)

-   Add rel=alternate \<link\> elements to translations of the current
    page (Issues #988, #989)

-   Added a INDEXES_PAGES_MAIN setting to show the page number on the
    index page if desired (True) (Issues #210, #987)

-   Added a TRANSLATIONS_PATTERN setting to specify the format for
    language-dependent filenames (Issue #990)

### Bugfixes<a href="#bugfixes-54" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Fixed deploy events if there is no TIMEZONE set (Issue #893 via
    #822)

-   Modified translation strings: "Posted", "Also available in", "More
    posts about" — may break backwards compatibility (Issue #905)
    Details: <a
    href="https://groups.google.com/forum/#!topic/nikola-discuss/ABXKk9G0_u0"
    class="reference external">https://groups.google.com/forum/#!topic/nikola-discuss/ABXKk9G0_u0</a>

-   Facebook comments are now showing properly

-   Added a warning/error when lessc/sass are missing (via Issue
    themes#24)
...
-   Fixed the deploy rsync example (rsync --delete doesn't work with
    '/\*' as source) (Issue #959)
...
## New in v6.2.1<a href="#new-in-v6-2-1" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-51" class="headerlink"
title="Permalink to this heading">¶</a>

-   Default themes adds semantic meanings to posts using h-entry (a
    microformats2) and HTML 5 microdata (Issue #867)

-   New "hidetitle" metadata to suppress printing a title as heading
    (Issue #584)
...
### Bugfixes<a href="#bugfixes-55" class="headerlink"
title="Permalink to this heading">¶</a>

-   Fixed some locale problems in posix systems (Issues #886, #884,
    #875)

-   Don’t include BLOG_DESCRIPTION as meta tag on tag and gallery pages
    (Issue #876)

## New in v6.2.0<a href="#new-in-v6-2-0" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-52" class="headerlink"
title="Permalink to this heading">¶</a>

-   RSS feeds for galleries (Issue #786)

-   New EXTRA_IMAGE_EXTENSIONS option, and support most common image
    extensions by default (Issue #857)

-   Add reStructuredText directive post_list (Issue #815)

-   Galleries support translations

-   Support a single archive per site (optional; instead of per-year or
    per-month archives) (Issue #853)

-   The locales used in testing can be specified in environment
    variables (Issue #818)

-   The locale to use with each language can be explicitly set (Issue
    #818)
...
### Bugfixes<a href="#bugfixes-56" class="headerlink"
title="Permalink to this heading">¶</a>

-   Don't create empty author elements, use dc:creator if author is not
    an email (Issue #868)

-   Added striphtml filter in mako templates, strip tags from titles
    (Issue #865)
...
-   Compilers now accept two of any line endings (n, rn) instead of only
    Unix (n) (Issue #832)
...
-   Exclude "html" files without a doctype decleration in sitemap (Issue
    #864)

-   Do not include "Read more" links at the end of teasers when
    stripping HTML

### Other<a href="#other-4" class="headerlink"
title="Permalink to this heading">¶</a>

-   the bpython console is now “slightly deprecated”

## New in v6.1.1<a href="#new-in-v6-1-1" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-53" class="headerlink"
title="Permalink to this heading">¶</a>

-   New Slovenian translation

### Bugfixes<a href="#bugfixes-57" class="headerlink"
title="Permalink to this heading">¶</a>

-   The build_less plugin was broken (Issue #802)

-   Every plugin now has its own LOGGER instance, with different names
    (Issue #797)
...
## New in v6.1.0<a href="#new-in-v6-1-0" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-54" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   New GALLERY_SORT_BY_DATE option, defaulting to True. If set to
    False, sorts by name (Issue #667)

### Bugfixes<a href="#bugfixes-58" class="headerlink"
title="Permalink to this heading">¶</a>

-   Fixed compatibility with Windows’ multiple partitions (Issues #776,
    #784)
...
-   Install enough of the theme chain to ensure themes are usable (Issue
    #748)

-   Support Gist URLs in the gist directive for compatibility with
    sphinx-gist-embed (Issue #754)

-   windows, dev - fix point pth to clone and run nikola without install
    (Issue #751)

-   windows - fix install from clone or from a Github download (Issue
    #747, Windows)

-   Make Listings directive inherit Include making it simpler and more
    powerful (Issue #744)
...
## New in v6.0.4<a href="#new-in-v6-0-4" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-55" class="headerlink"
title="Permalink to this heading">¶</a>

-   New :doc: role for reStructuredText compiler, creates a link to
    another post / page inside the same site (Issue #724)

### Bugfixes<a href="#bugfixes-59" class="headerlink"
title="Permalink to this heading">¶</a>

-   Added missing metadata in internals.txt and extending.txt (Issue
    #738)
...
-   Add files used by the listings directive as dependencies (Issue
    #723)
...
-   Be less agressive in hyphenating, also, split words differently.
    (Issue #718)
...
-   Consider the current theme chain's parent, bundles and engine part
    of the file_dep for files created by generic_page_renderer (Issue
    #711)

## New in v6.0.3<a href="#new-in-v6-0-3" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-56" class="headerlink"
title="Permalink to this heading">¶</a>

-   New --strict option for build command, makes warnings abort the
    build (Issue #704) Still doesn't really affect behaviour, because
    each warning needs to check it.

### Bugfixes<a href="#bugfixes-60" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Normalize paths in task targets, helping detect conflicts (Issue
    #546)

-   Strip multiple digits in unslugify, used by image galleries (Issue
    #703)

-   Added missing defaults and make Nikola work with empty conf.py
    (Issue #697)

-   Add thumbnails as file dependencies of gallery indexes (Issue #551)

-   Copy original image as thumbnail if PIL fails to resize it (Issue
    #551)
...
## New in v6.0.2<a href="#new-in-v6-0-2" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-57" class="headerlink"
title="Permalink to this heading">¶</a>

-   Support for external gzip commands (Issue #351)

### Bugfixes<a href="#bugfixes-61" class="headerlink"
title="Permalink to this heading">¶</a>
...
## New in v6.0.1<a href="#new-in-v6-0-1" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-58" class="headerlink"
title="Permalink to this heading">¶</a>
...
### Bugfixes<a href="#bugfixes-62" class="headerlink"
title="Permalink to this heading">¶</a>
...
## New in v6.0.0<a href="#new-in-v6-0-0" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-59" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   New multiple comment system support (Issue #606, #634)
    ...
    -   New COMMENT_SYSTEM option to change comment systems, defaults to
        disqus
...
-   Made AddThis support replaceable through new SOCIAL_BUTTONS_CODE
    option.
...
-   Separate slides.tmpl template so that non-bootstrap themes can
    support them.

-   New ADDITIONAL_METADATA option to specify metadata to include in the
    new_post command, alongside with the defaults (Issue #622)

-   Schedule new posts automatically by specifying an iCal recursive
    rule as SCHEDULE_RULE (Issue #602)

### Bugfixes<a href="#bugfixes-63" class="headerlink"
title="Permalink to this heading">¶</a>

-   Added missing rel="self" link suggested by feedvalidator.org (Issue
    #264)
...
-   Refactored crumb bar into a separate tmpl to avoid code duplication
    (Issue #612)

-   Fix broken config dep for tags when NAVIGATION_LINKS is not set
    (Issue #610)
...
-   Deprecated SIDEBAR_LINKS, replaced with NAVIGATION_LINKS (Issue #104
    #601)
...
-   Right-align image title in colorbox to avoid overlapping so much
    (Mentioned in Issue #570)

-   Added LICENSE in the footer (Issue #528)

-   Use random IDs for slides so you can have more than one in a page
    (Issue #572)

## New in v5.5.1<a href="#new-in-v5-5-1" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-60" class="headerlink"
title="Permalink to this heading">¶</a>
...
### Bugfixes<a href="#bugfixes-64" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Made `nikola help` much more resilient against broken conf.py (Issue
    #550)
...
-   Revamped `requirements.txt` — now `requirements.txt` contains the
    ...
    <span class="pre">`requirements-full.txt`</span> contains the
...
-   Fixed installation under pip 1.4 or later (pytz and yapsy versions
    must be hardcoded due to crazy versioning schemes)

-   Added .rst to the default reStructuredText extensions (via Issue
    #542)
...
-   Fixed IPython plugin to work with the latest IPython.nbconvert
    machinery

-   Fixed failing build because of hidden folders and files inside post
    folder

## New in v5.5<a href="#new-in-v5-5" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-61" class="headerlink"
title="Permalink to this heading">¶</a>

-   New HIDE_SOURCELINK option (defaults to False)

-   Switched theme repo to <a href="http://themes.nikola.ralsina.com.ar"
    class="reference external">http://themes.nikola.ralsina.com.ar</a>
    (Issue #411)

-   New (untested) ASCIIDoc compiler

-   Display very annoying warning when deploying the nikolademo Disqus
    account

-   New Bulgarian translation

-   New man page (created with help2man nikola -N --version-string=5.5)
    (Issue #460)
...
-   New MARKDOWN_EXTENSIONS option, defaults to previopus behaviour
    (Issue #496)

-   Posts with dates in the future will be treated as drafts
    (Implemented by punchagan)

-   New "TaskMultiplier" plugin category, takes a task, returns 0 or
    more new tasks (Issue #483)
...
### Bugfixes<a href="#bugfixes-65" class="headerlink"
title="Permalink to this heading">¶</a>

-   Improve custom.css detection (Issue #526)

-   Fixed bad interaction between 2-file-format and untranslated posts
    in multilingual sites (Issue #525)
...
-   Use schema-relative URL for addthis to avoid insecure page warnings
    on HTTPS sites (Issue #510)

-   Made the gzip plugin generate less confusing task names (no more
    double colon)
...
-   Avoid \_\_future\_\_ in setup.py because it breaks buildout (Issue
    #478)
...
-   Wordpress import: write correct redirections for URLs not ending in
    an / (Issue #459)

## New in v5.4.4<a href="#new-in-v5-4-4" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-62" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   New HIDE_UNTRANSLATED_POSTS option that ensures you don't have
    mixed-language pages (Issue #373)

-   New theme "site-planetoid" for use with the planetoid plugin.

-   New 'retired' tag for posts that should no longer be in feeds.

### Bugfixes<a href="#bugfixes-66" class="headerlink"
title="Permalink to this heading">¶</a>

-   Added post data as a uptodate check for mustache (Issue #456)

-   Rebuild post pages when the post's translation list changes (Issue
    #458)
...
-   local search and mustache plugins must be disabled by default (Issue
    #437)

-   Avoid failure if there are no tags and USE_GZIP is enabled (Issue
    #439)

-   Fix aspect ratio detection in Vimeo videos (Issue #440)

-   Blogger importer was passing wrong options to "nikola init" (Issue
    #408)

## New in v5.4.3<a href="#new-in-v5-4-3" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-63" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   New "nocomments" metadata that disables comments for a page/post
    (Issue #278)

-   New HIDE_UNTRANSLATED_POSTS option (does nothing yet)

-   New EXTRA_HEAD_DATA option, which adds extra things in \<HEAD\>
    (Issue #385)
...
-   New "template" metadata that changes the template for a page/post
    (Issue #199)
...
### Bugfixes<a href="#bugfixes-67" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Set locale to the value of "lang" in templates, so things like
    strftime use localized values. (Issue #368)
...
-   Warn if combining USE_CDN with a theme providing a copy of bootstrap
    (Issue #386)
...
-   New function messages(msgid, lang=current_lang) available for
    templates
...
-   All RSS feed links for tags pointed to the DEFAULT_LANG one in some
    themes.

-   Nikola.link and Nikola.path are now locale aware and lang is
    optional.
...
-   Blogger import: imports will not result in an TypeError because
    str.join expects all it's arguments to be of type str

## New in v5.4.2<a href="#new-in-v5-4-2" class="headerlink"
title="Permalink to this heading">¶</a>

### Bugfixes<a href="#bugfixes-68" class="headerlink"
title="Permalink to this heading">¶</a>
...
## New in v5.4<a href="#new-in-v5-4" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-64" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   New GZIP_FILES/GZIP_EXTENSIONS options to create gzipped copies of
    some files (Issue #348)
...
### Bugfixes<a href="#bugfixes-69" class="headerlink"
title="Permalink to this heading">¶</a>

-   Added missing \</div\> in default theme templates.

-   Wordpress import: Description is left empty if no description is
    found.
...
-   Make commands that need to be run in a site fail gracefully (Issue
    #342)

-   Use localized links on lxml fixer

-   Redirections created during the import from wordpress are now
    written to conf.py
...
## New in v5.3<a href="#new-in-v5-3" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-65" class="headerlink"
title="Permalink to this heading">¶</a>

-   Bootstrap 2.3.0

-   Optionally use content distribution networks for jquery and
    twitter-bootstrap (USE_CDN option)

-   Improve progressive rendering by moving javascript to the bottom of
    pages
...
### Bugfixes<a href="#bugfixes-70" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Use source files as bundle dependencies instead of outputs (Issue
    #294)

## New in v5.2<a href="#new-in-v5-2" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-66" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   One-page, dynamic-loading, client-rendered site plugin
    (task_mustache)
...
-   Custom "gist" directive providing reStructured text support for
    GitHub gists.
...
-   When using import_wordpress users can exclude drafts with the
    <span class="pre">`-d`</span> switch.
...
-   When running the init command it now creates an empty site by
    default. The previous behaviour can be triggered with the "--demo"
    switch.

-   Python 3 support (except for sitemap generation)

### Bugfixes<a href="#bugfixes-71" class="headerlink"
title="Permalink to this heading">¶</a>

-   Added sane defaults for most options, so you can have a lean config
    file.

-   Made layout of the site theme responsive, with collapsing navbar.

-   Use timeline instead of parsing post_pages in generic_page_renderer
    and task_render_pages.

-   Updated disqus integration code, added identifiers so it works on
    any URL.
...
## New in v5.1<a href="#new-in-v5-1" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-67" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Added unstyled theme "orphan", useful as a base for independent
    themes.
...
### Bugfixes<a href="#bugfixes-72" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Switched addThis to Peekaboo style, as seen on flexion.org (seems
    less broken)

-   Remove duplicated sample config file. always build it from template
    (schettino72)

-   Don't use hardcoded path for custom.css (schettino72)

-   Wordpress importer: fixed issue 190, convert embedded H1 tags into
    H2
...
## New in v5<a href="#new-in-v5" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-68" class="headerlink"
title="Permalink to this heading">¶</a>
...
### Bugfixes<a href="#bugfixes-73" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Fixed Issue 161: webassets setting USE_BUNDLES was ignored (fix by
    schettino72)

-   Fixed Issue 153: index.txt was being ignored in galleries.

## New in v4.0.3<a href="#new-in-v4-0-3" class="headerlink"
title="Permalink to this heading">¶</a>

### Bugfixes<a href="#bugfixes-74" class="headerlink"
title="Permalink to this heading">¶</a>
...
## New in v4.0.2<a href="#new-in-v4-0-2" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-69" class="headerlink"
title="Permalink to this heading">¶</a>
...
### Bugfixes<a href="#bugfixes-75" class="headerlink"
title="Permalink to this heading">¶</a>
...
-   Don't say "reSt", say "Source" since it can be markdown or other
    stuff.

## New in v4.0.1<a href="#new-in-v4-0-1" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-70" class="headerlink"
title="Permalink to this heading">¶</a>
...
### Bugfixes<a href="#bugfixes-76" class="headerlink"
title="Permalink to this heading">¶</a>
...
## New in v4<a href="#new-in-v4" class="headerlink"
title="Permalink to this heading">¶</a>

### Features<a href="#features-71" class="headerlink"
title="Permalink to this heading">¶</a>
...
### Bugfixes<a href="#bugfixes-77" class="headerlink"
title="Permalink to this heading">¶</a>
