...
-   <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"
    ...
    <a href="#" class="dropdown-item active">conf.py <span
...
-   <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"
    ...
    data-cfemail="07696e6c686b66476b6e6562756629646f6673">[email protected]</span>)</a>
...
-   <a href="conf.rst" id="sourcelink" class="nav-link">Page Source</a>

# <a href="#" class="u-url">Nikola v8.3.2 configuration file</a>

The default config file for Nikola v8.3.2 is reproduced below.

<a href="https://getnikola.com/listings/conf.py"
class="btn btn-primary">Download conf.py</a>

<a href="listings/conf.py.html" class="reference external">conf.py</a>
<a href="listings/conf.py" class="reference external">(Source)</a>
...
# "rsync -rav --delete --delete-after output/ [email protected]:/srv/www/site"
